...
function CartFlowsCheckoutLayout1Frontend({ element }: { element: any }) {
    ...
    const title = s.content?.title || "Complete Your Order — One Page Checkout";
    const selectedProductIds: string[] = s.content?.selected_products || [];
    const buttonText = s.content?.button_text || "Place Order Now";
    ...
    return (
        <section className="w-full py-8 px-4 sm:px-6 bg-gray-50/50">
            ...
            <div className="max-w-5xl mx-auto bg-white rounded-3xl border border-gray-200/80 shadow-2xl p-6 sm:p-10 space-y-8">
                <div className="border-b border-gray-100 pb-4">
                    <h2 className="text-2xl font-black text-gray-900 flex items-center gap-2.5">
                        <Icon icon="solar:shield-check-bold" className="text-emerald-600" width={28} />
                        {title}
                    </h2>
                    <p className="text-xs text-gray-500 mt-1">Enter your details and place your order in 1 easy step.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-6 space-y-5 bg-gray-50/60 p-6 rounded-2xl border border-gray-100">
                        <h3 className="text-base font-bold text-gray-900 flex items-center gap-2 border-b border-gray-200/70 pb-3">
                        ...
                        <div className="flex flex-wrap -mx-2 gap-y-4">
                            <div className="w-full md:w-1/2 px-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-xs sm:text-sm outline-none focus:border-emerald-500 focus:bg-white transition bg-white"
                                />
                            </div>
                            ...
                            <div className="w-full px-2">
                                <label className="block text-xs font-bold text-gray-700 mb-1">Full Delivery Address</label>
                                <textarea
                                    rows={2}
                            ...
                            {states.length > 0 && (
                                <div className="w-full md:w-1/2 px-2">
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-xs sm:text-sm outline-none focus:border-emerald-500 bg-white"
                                    >
                            ...
                            <div className="w-full px-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-3.5 py-2.5 rounded-xl border border-gray-200 text-xs outline-none focus:border-emerald-500 transition bg-white"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-6 space-y-6">
                        <div className="bg-gray-50/60 p-6 rounded-2xl border border-gray-100 space-y-4">
                            ...
                            {loadingProducts ? (
                                ...
                                <p className="text-xs text-gray-400 italic">No products configured for this checkout layout.</p>
                            ) : (
                                <div className="space-y-4">
                                    {products.map((p) => {
                                        ...
                                        return (
                                            <div
                                                key={p._id}
                                                className="bg-white p-4 rounded-xl border border-gray-200/80 space-y-3 shadow-2xs"
                                            >
                                                <div className="flex items-center justify-between gap-3">
                                                    <div className="flex items-center gap-3 min-w-0">
                                                        ...
                                                        <div className="min-w-0">
                                                            ...
                                                            <p className="text-xs text-emerald-600 font-extrabold">{fmt(effectivePrice)}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden shrink-0">
                                                        <button
                                                            ...
                                                            className="px-2 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs font-bold"
                                                        >
                                                            -
                                                        </button>
                                                ...
                                                {/* Variant Attributes Selection Chips */}
                            ...
                            <div className="pt-3 border-t border-gray-200/70 space-y-2">
                                <label className="block text-xs font-bold text-gray-800">Shipping Method</label>
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    >
                                        ...
                                        <span className="text-[11px] text-emerald-600 font-bold mt-1 ml-5">
                            ...
                            <div className="pt-3 border-t border-gray-200/70 space-y-2">
                                <label className="block text-xs font-bold text-gray-800">Select Payment Method</label>
                                <div className="grid grid-cols-2 gap-2">
                                    <label
                            ...
                            {/* TOTAL BREAKDOWN */}
                            <div className="pt-3 border-t border-gray-200/70 space-y-1.5 text-xs text-gray-600">
                                <div className="flex justify-between">
                                    <span>Items Subtotal</span>
                                    <span className="font-bold text-gray-900">{fmt(itemsSubtotal)}</span>
                                </div>
                                <div className="flex justify-between">
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="w-full py-4 px-8 rounded-2xl bg-linear-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white text-base sm:text-lg font-black shadow-xl shadow-emerald-600/25 active:scale-[0.99] transition disabled:opacity-50 flex items-center justify-center gap-2"
                        >
                            {submitting ? (
                                <>
...
const cartFlowsCheckoutLayout1Element = {
    type: "cartflows-checkout-1",
    category: "cartflows",
    label: "CartFlows One Page Checkout — Modern Light",
    icon: "solar:cart-check-bold-duotone",

    schema: {
        content: {
            title: "Complete Your Order — One Page Checkout",
            selected_products: [],
    ...
    controls: [
        {
            tab: "Content",
            section: "One Page Checkout Settings",
            controls: [
                {
                    name: "title",
                    render: (val: any, onChange: any) => (
                        <Text label="Header Title" value={val ?? "Complete Your Order"} onChange={onChange} />
                    ),
                },
                {
                ...
                },
                {
                    name: "button_text",
                    render: (val: any, onChange: any) => (
                        <Text label="Submit Button CTA" value={val ?? "Place Order Now"} onChange={onChange} />
                    ),
                },
            ],
        },
    ...
    render: (element: any) => <CartFlowsCheckoutLayout1Frontend element={element} />,
};

export default cartFlowsCheckoutLayout1Element;
